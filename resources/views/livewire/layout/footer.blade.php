    ...
    <div class="mx-auto max-w-screen-xl">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="/" class="flex items-center">
                    <img src="{{ asset('logo.png') }}" class="h-8" alt="Ritmiemde Logo">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap ml-2">Ritmiemde</span>
                </a>
                <p class="mt-2 text-gray-600 max-w-xs">Bringing back the joy of reading with interactive flipbooks.</p>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-600">
                        <li class="mb-4">
                            <a href="#" class="hover:underline hover:text-primary">Help Center</a>
                        </li>
                        <li>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center">© 2025 <a href="/"
                    class="hover:underline">Ritmiemde</a>. All Rights Reserved.
            </span>
